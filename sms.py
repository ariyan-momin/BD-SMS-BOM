...
os.system('clear')
logo2= ('''\033[1;31m
      8888888b.   .d88888b. Y88b   d88P 
      888   Y88b d88P" "Y88b Y88b d88P  
      888    888 888     888  Y88o88P   
      888   d88P 888     888   Y888P    
      8888888P"  888     888   d888b    
      888 T88b   888     888  d88888b   
      888  T88b  Y88b. .d88P d88P Y88b  
      888   T88b  "Y88888P" d88P   Y88b                                                                                                                                          
\033[1;36m============================================================

\033[1;92m[+] AUTHOR       :   Md. Momin 
\x1b[1;92m[+] FACEBOOK     :   Ariyan Momin 
\x1b[1;92m[+] GITHUB       :   ariyan-momin
\x1b[1;12m[+] TEAM         :   \33[1;42  MOMIN\33[0m
...
if 'ARIYAN'==user and 'MOMIN'==pas:
        ...
        time.sleep(2)
        os.system('xdg-open https://www.facebook.com/momin420n')
        exit()
...
for i in range(amo):
        ...
        input(g+"\n\t\t\tEnter For Continue")
        os.system("clear")
        os.system("https://www.facebook.com/Momin420n?mibextid=ZbWKwL")
